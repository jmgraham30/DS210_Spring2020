...
The reason why we do this is because resapling with replacement from a sample is effectively estimating the sampling distribution by way of simulation.  
